...
CanTxMsg TxMessageArray[] ={
					 ...
					 {0x201, 0x00000000, CAN_Id_Standard, CAN_RTR_Data, 4, {0x21, 0x21, 0x21, 0x21}},
					 ...
					 {0x321, 0x00000000, CAN_Id_Standard, CAN_RTR_Data, 4, {0x31, 0x31, 0x31, 0x31}},
