...
void MyCAN_Init(void)
{
	...
	CAN_FilterInitStructure.CAN_FilterIdLow = 0x200<<5;
	CAN_FilterInitStructure.CAN_FilterMaskIdLow = (0x700<<5) | 0x10 | 0x08;
	
	CAN_FilterInitStructure.CAN_FilterIdHigh = 0x320<<5;
	CAN_FilterInitStructure.CAN_FilterMaskIdHigh = (0x7F0<<5) | 0x10 | 0x08;
	...
	CAN_FilterInitStructure.CAN_FilterIdLow = 0x420<<5;
	CAN_FilterInitStructure.CAN_FilterMaskIdLow = (0x700<<5) | 0x10 | 0x08;
	
	CAN_FilterInitStructure.CAN_FilterIdHigh = 0x520<<5;
	CAN_FilterInitStructure.CAN_FilterMaskIdHigh = (0x7F0<<5) | 0x10 | 0x08;
