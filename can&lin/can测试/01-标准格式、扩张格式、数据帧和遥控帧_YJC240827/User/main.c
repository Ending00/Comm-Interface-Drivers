...
CanTxMsg TxMessageArray[] ={
                     ...
                     {0x666, 0x00000000, CAN_Id_Standard, CAN_RTR_Remote, 4, {0x00, 0x00, 0x00, 0x00}},
					 {0x000, 0x55667788, CAN_Id_Extended, CAN_RTR_Data,   4, {0x55, 0xAA, 0x55, 0xAA}},
                     {0x000, 0xAABBCCDD, CAN_Id_Extended, CAN_RTR_Remote, 4, {0x00, 0x00, 0x00, 0x00}}
                           };                         //复合结构体数组
...
//	OLED_ShowHexNum(1, 6, TxMessage.StdId, 3);
