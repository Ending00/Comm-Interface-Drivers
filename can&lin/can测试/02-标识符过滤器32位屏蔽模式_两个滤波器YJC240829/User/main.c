...
CanTxMsg TxMessageArray[] ={
	              /** StdId     ExtId          IDE            RTR      DLC          Data[4]***/
                     {0x000, 0x12345600, CAN_Id_Extended, CAN_RTR_Remote, 4, {0x11, 0x11, 0x00, 0x00}},
                     {0x000, 0x12345601, CAN_Id_Extended, CAN_RTR_Data, 4, {0x22, 0x22, 0x22, 0x22}},
					 {0x000, 0x12345602, CAN_Id_Extended, CAN_RTR_Remote, 4, {0x33, 0x33, 0x00, 0x00}},
					 {0x000, 0x123456FF, CAN_Id_Extended, CAN_RTR_Data, 4, {0x44, 0x44, 0x44, 0x44}},
					 
					 {0x123, 0x00000000, CAN_Id_Standard, CAN_RTR_Data, 4, {0xAA, 0xAA, 0xAA, 0xAA}},
					 {0x234, 0x00000000, CAN_Id_Standard, CAN_RTR_Data, 4, {0xBB, 0xBB, 0xCC, 0xDD}},
					 {0x345, 0x00000000, CAN_Id_Standard, CAN_RTR_Data, 4, {0xAA, 0xAA, 0xAA, 0xAA}},
					 {0x456, 0x00000000, CAN_Id_Standard, CAN_RTR_Data, 4, {0xCC, 0xCC, 0xCC, 0xCC}},
					 
					 {0x000, 0x0789AB00, CAN_Id_Extended, CAN_RTR_Remote, 4, {0xAA, 0xAA, 0x00, 0x00}},
					 {0x000, 0x0789AB01, CAN_Id_Extended, CAN_RTR_Data, 4, {0x55, 0x55, 0x55, 0x55}},
					 {0x000, 0x0789AB02, CAN_Id_Extended, CAN_RTR_Remote, 4, {0x66, 0x66, 0x00, 0x00}},
					 {0x000, 0x0789ABFF, CAN_Id_Extended, CAN_RTR_Data, 4, {0xFF, 0xFF, 0xFF, 0xFF}},
					 
					 {0x678, 0x00000000, CAN_Id_Standard, CAN_RTR_Data, 4, {0xAA, 0xAA, 0xAA, 0xAA}},
					 {0x789, 0x00000000, CAN_Id_Standard, CAN_RTR_Data, 4, {0xBB, 0xBB, 0xCC, 0xDD}},
					 {0x890, 0x00000000, CAN_Id_Standard, CAN_RTR_Data, 4, {0xAA, 0xAA, 0xAA, 0xAA}},
					 {0x891, 0x00000000, CAN_Id_Standard, CAN_RTR_Data, 4, {0xAA, 0xAA, 0xAA, 0xAA}}
					        };                         //复合结构体数组
