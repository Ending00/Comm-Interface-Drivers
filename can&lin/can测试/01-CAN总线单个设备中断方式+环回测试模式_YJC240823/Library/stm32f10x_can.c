...
/**
  ...
  *                  This parameter can be one of the following flags: 
  *                 11-  CAN_IT_TME              Transmit mailbox empty Interrupt 
  *                   -  CAN_IT_FMP0             FIFO 0 message pending Interrupt 
  *                 22-  CAN_IT_FF0              FIFO 0 full Interrupt        
  *                 33-  CAN_IT_FOV0             FIFO 0 overrun Interrupt 
  *                   -  CAN_IT_FMP1             FIFO 1 message pending Interrupt 
  *                 44-  CAN_IT_FF1              FIFO 1 full Interrupt  
  *                 55-  CAN_IT_FOV1             FIFO 1 overrun Interrupt 
  *                 66-  CAN_IT_WKU              Wake-up Interrupt
  *                 77-  CAN_IT_SLK              Sleep acknowledge Interrupt
  *                 88-  CAN_IT_EWG              Error warning Interrupt
  *                 99-  CAN_IT_EPV              Error passive Interrupt
  *                 10-  CAN_IT_BOF              Bus-off Interrupt
  *                 11-  CAN_IT_LEC              Last error code Interrupt 
  *                 12-  CAN_IT_ERR              Error Interrupt
...
/**
  ...
  *                  77-  CAN_IT_SLK             Sleep acknowledge Interrupt
  *                  88-  CAN_IT_EWG             Error warning Interrupt
  *                  99-  CAN_IT_EPV             Error passive Interrupt  passive:被动的，消极的
  *                  10-  CAN_IT_BOF             Bus-off Interrupt
  *                  11-  CAN_IT_LEC             Last error code Interrupt
  *                  12-  CAN_IT_ERR             Error Interrupt  
  * @retval None.
