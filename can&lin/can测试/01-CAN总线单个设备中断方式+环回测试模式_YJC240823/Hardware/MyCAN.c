...
void MyCAN_Init(void)
{
	...
	CAN_InitStruct.CAN_BS2 = CAN_BS2_3tq; //可以计算出波特率为36M/48/(1+2+3)=125K,其中BS1、BS2和Prescaler的值可以自己设置，只需计算结果在125K-1M之间即可
	...
	CAN_FilterInitStruct.CAN_FilterIdLow = 0x0000;                //全通模式
