...
CanTxMsg TxMessageArray[] ={
	              /** StdId     ExtId          IDE            RTR      DLC          Data[4]***/
					 ...
					 {0x567, 0x00000000, CAN_Id_Standard, CAN_RTR_Data, 4, {0x56, 0x56, 0x56, 0x56}},
                     {0x678, 0x00000000, CAN_Id_Standard, CAN_RTR_Data, 4, {0x67, 0x67, 0x67, 0x67}},
					 {0x789, 0x00000000, CAN_Id_Standard, CAN_RTR_Data, 4, {0x78, 0x78, 0x78, 0x78}},
					 {0x890, 0x00000000, CAN_Id_Standard, CAN_RTR_Data, 4, {0x89, 0x89, 0x89, 0x89}},
					 ...
					 {0x000, 0xAAAAAAAA, CAN_Id_Extended, CAN_RTR_Data, 4, {0x77, 0x77, 0x77, 0x77}},
					 {0x000, 0xBBBBBBBB, CAN_Id_Extended, CAN_RTR_Data, 4, {0x88, 0x88, 0x88, 0x88}}
