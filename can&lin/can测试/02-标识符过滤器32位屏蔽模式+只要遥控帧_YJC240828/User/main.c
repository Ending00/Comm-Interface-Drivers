...
CanTxMsg TxMessageArray[] ={
	              /** StdId     ExtId          IDE            RTR      DLC          Data[4]***/
                     ...
                     {0x000, 0x12345601, CAN_Id_Extended, CAN_RTR_Remote, 4, {0x00, 0x00, 0x00, 0x00}},
					 {0x000, 0x123456FF, CAN_Id_Extended, CAN_RTR_Data, 4, {0x33, 0x33, 0x33, 0x33}},
					 {0x123, 0x00000000, CAN_Id_Standard, CAN_RTR_Remote, 4, {0x00, 0x00, 0x00, 0x00}},
					 {0x000, 0x0789AB00, CAN_Id_Extended, CAN_RTR_Data, 4, {0x44, 0x44, 0x44, 0x44}},
					 {0x000, 0x0789AB01, CAN_Id_Extended, CAN_RTR_Remote, 4, {0x55, 0x55, 0x55, 0x55}},
					 {0x000, 0x0789ABFF, CAN_Id_Extended, CAN_RTR_Remote, 4, {0xFF, 0xFF, 0xFF, 0xFF}}
