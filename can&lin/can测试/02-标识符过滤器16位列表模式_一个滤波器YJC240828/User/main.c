...
CanTxMsg TxMessageArray[] ={
					 ...
					 {0x122, 0x00000000, CAN_Id_Standard, CAN_RTR_Remote, 4, {0x12, 0x12, 0x12, 0x12}},
					 
                     {0x234, 0x00000000, CAN_Id_Standard, CAN_RTR_Data, 4, {0x23, 0x23, 0x23, 0x23}},
					 {0x341, 0x00000000, CAN_Id_Standard, CAN_RTR_Remote, 4, {0x34, 0x34, 0x34, 0x34}},
					 
					 {0x345, 0x00000000, CAN_Id_Standard, CAN_RTR_Data, 4, {0x34, 0x34, 0x34, 0x34}},
					 {0x456, 0x00000000, CAN_Id_Standard, CAN_RTR_Remote, 4, {0x45, 0x45, 0x45, 0x45}},
