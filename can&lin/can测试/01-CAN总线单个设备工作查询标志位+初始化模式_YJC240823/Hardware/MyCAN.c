...
//	CAN_InitStruct.CAN_Mode = CAN_Mode_LoopBack;             //回环模式,可发送报文，同时接受报文成功
//	CAN_InitStruct.CAN_Mode = CAN_Mode_Silent;               //静默模式，可发送报文，但接受报文失败
//    CAN_InitStruct.CAN_Mode = CAN_Mode_Silent_LoopBack;      //环回静默模式，可发送报文，同时接受报文成功	
//    CAN_InitStruct.CAN_Mode = CAN_OperatingMode_Normal;	     //正常工作模式，可发送报文，同时接受报文成功
//    CAN_InitStruct.CAN_Mode = CAN_OperatingMode_Sleep;           //睡眠工作模式，可发送报文，但接受报文失败
      CAN_InitStruct.CAN_Mode = CAN_OperatingMode_Initialization;    //初始化工作模式，可发送报文，但接受报文失败
