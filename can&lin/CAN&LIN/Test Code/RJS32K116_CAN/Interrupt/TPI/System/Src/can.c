...
void CAN_Init(CAN_InitTypeDef *CANInitStructure)
{
    ...
    */
    ...
    CAN->CAN_CR1 = (0X03 << 28);            //AFWL = 0X03
    CAN->CAN_CR1 &= ~(0x0F<<24);            //EWL = 0

//    CAN->CAN_CR1 |= 1<<1;                   //EIE
//    CAN->CAN_CR1 |= 1<<2;                   //TSIE
    CAN->CAN_CR1 |= 1<<3;                   //TPIE
//    CAN->CAN_CR1 |= 1<<1;                   //RAFIE
//    CAN->CAN_CR1 |= 1<<1;                   //RFIE
//    CAN->CAN_CR1 |= 1<<1;                   //ROIE
//    CAN->CAN_CR1 |= 1<<1;                   //RIE
   
//    CAN->CAN_CR1 |= 1<<1;                   //BEIE
//    CAN->CAN_CR1 |= 1<<1;                   //ALIE
//    CAN->CAN_CR1 |= 1<<1;                   //EPIE
