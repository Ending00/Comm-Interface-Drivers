...
//    CRG->CAN_CTRL |= (uint32_t)1<<30;           //CAN工作时钟选择：HSE 
    ...
    CRG->CAN_CTRL |= 72<<22;                //CAN TIMER CLK 72分频   
    ...
    CAN_InitStructure.SBitRateInitStructure.S_Presc = 1;
